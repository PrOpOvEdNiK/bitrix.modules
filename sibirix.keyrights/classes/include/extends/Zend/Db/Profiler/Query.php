...
class Zend_Db_Profiler_Query
{
    ...
    public function bitrixFixElapsed($elapsed){
        $this->end();
        $this->_startedMicrotime = $this->_endedMicrotime - $elapsed;
        $this->useBitrix();
    }

    public function useBitrix() { 
        $this->_isBitrix = true;
    }

    public function isBitrix() {
        return $this->_isBitrix;
    }
}
